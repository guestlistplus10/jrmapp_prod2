...
function Header() {
  ...
  return (
    <header className="header-main full-height valign bg-img parallaxie" data-background="/dark/assets/imgs/jrmwebimg/studiopic/studiopic11.jpg"
      data-overlay-dark="6">
      <div className="container ontop">
        <div className="row">
          <div className="col-lg-8">
            <div className="caption">
              <h5 className="fw-300 mb-15">Label owned studio</h5>
              <h1 className="fz-80">For your creative ideas!</h1>
            </div>
          </div>
