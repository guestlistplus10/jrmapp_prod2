        ...
        <div className="sec-head mb-80">
          <div className="row">
            <div className="col-lg-8">
              <h6 className="sub-title opacity-8 wow fadeInUp">Juniormafia</h6>
          ...
          <div className="col-lg-3 col-md-6">
            <div className="item-join valign">
              <div className="full-width">
                <h6 className="text-u ls2">Werde <br /> Mitglied</h6>
                <Link href="/jrmwebsite/contact" className="arrow mt-30">
                  ...
                  <span className="fz-12 text-u ml-10">Bewirb dich</span>
                </Link>
              </div>
            </div>
          </div>
