...
function MainNavbar({ lightMode, mainBg, subBg, noStatic }) {
  ...
  return (
    <nav className={`navbar navbar-expand-lg ${noStatic ? '' : 'static'} ${mainBg ? 'main-bg' : ''} ${subBg ? 'sub-bg' : ''}`}>
      <div className="container">
        ...
        <div className="collapse navbar-collapse justify-content-center" id="navbarSupportedContent" onClick={toggleNavbar}>
